...
> **New here? Jump straight to [Quick Start](#usage) or see it catch a fake gateway in [Testing the Detector](#testing-the-detector).**
...
No license specified yet. Add a `LICENSE` file (MIT is a common choice for security tooling) to define usage terms before distributing this publicly.

---

<div align="center">

**Built for defenders, not attackers.** Use responsibly. 🔐
